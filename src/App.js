...
function App() {
    const { validateEmail, validatePassword, getPasswordStrength, username, password, setLoginEnabled, setEmailValid, setPasswordValid, setPasswordStrength, } = useLogin();
    React.useEffect(() => {
